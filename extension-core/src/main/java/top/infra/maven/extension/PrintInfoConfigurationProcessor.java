...
@Named
@Singleton
public class PrintInfoConfigurationProcessor implements OrderedConfigurationProcessor {
    ...
    @Inject
    public PrintInfoConfigurationProcessor(
    ...
    @Override
    public int getOrder() {
        return Orders.CONFIGURATION_PROCESSOR_ORDER_PRINT_INFO;
    }
