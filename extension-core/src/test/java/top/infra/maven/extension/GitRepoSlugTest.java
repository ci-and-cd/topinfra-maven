...
import static top.infra.maven.extension.MavenBuildExtensionOption.PATTERN_GIT_REPO_SLUG;
import static top.infra.maven.extension.MavenBuildExtensionOption.gitRepoSlugFromUrl;
